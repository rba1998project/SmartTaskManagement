...
export const routes: Routes = [
  ...
  { path: 'register', data: { title: 'Create Account' }, loadComponent: () => import('./features/auth/register/register.component').then(m => m.RegisterComponent) },
  {
    ...
    children: [
      ...
      { path: 'users', canActivate: [roleGuard], data: { title: 'User Management', roles: [UserRole.Admin] }, loadComponent: () => import('./features/users/users.component').then(m => m.UsersComponent) },
